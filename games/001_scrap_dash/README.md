...
The PlayMode evidence suite drives real Input System keyboard/gamepad devices and physical Level 1 triggers for movement, jump, dash, pause/restart, scrap collection, checkpoint respawn, hazards, the moving cart, Magnet Lift and a complete locked-gate-to-win loop.
